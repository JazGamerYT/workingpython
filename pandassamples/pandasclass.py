...
dictionary={'one':pd.Series(data=[1,2,3,4,5],index=['carlos','juan','pepe','lucas','yusseppe']),
            'two':pd.Series(data=[1,2,3,4,5],index=['carlos','juan','pepe','lucas','yusseppe'])}
...
df1=df.insert(1,'copy of one',df['one'])
...
#vamos a fusionar las dos bases de datos para decir cuales son las peliculas de animacion
...
print('ratings')
print(tags.columns)
#filtrar las peliculas que sean de solo de animacion mayor a 4, fusionar las dos bases de datos